"TableToKeyValues"
{
	...
	"contents"
	{
		...
		{
			"type"		"header"
			"text"		"For accurate positions, use Advanced"
		}
		"14"
		{
			"type"		"header"
			"text"		"Bonemerge tool to attach the effect to "
		}
		"15"
		{
			"type"		"header"
			"text"		"the hat's first listed bone after 'none'."
		}
		"16"
		{
			"type"		"header"
		...
		{
			"type"		"header"
			"text"		"For the alternate position from TF2's"
		}
		"18"
		{
			"type"		"header"
			"text"		"'Adjust Unusual' setting, attach it to"
		}
		"19"
		{
			"type"		"header"
			"text"		"the bone 'bip_head' (or 'prp_hat'/"
		}
		"20"
		{
			"type"		"header"
			"text"		"'prp_helmet') instead, if possible."
		}
		"21"
		{
			"type"		"header"
